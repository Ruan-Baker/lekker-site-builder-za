      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="grid grid-cols-3 gap-8 max-w-3xl mx-auto">
          <div className="text-center">
            <div className="text-5xl font-bold text-gray-900 mb-2">700%</div>
            <p className="text-gray-700">Higher Conversion</p>
          </div>
          <div className="text-center">
            <div className="text-5xl font-bold text-gray-900 mb-2">42x</div>
            <p className="text-gray-700">Faster Building</p>
          </div>
          <div className="text-center">
            <div className="text-5xl font-bold text-gray-900 mb-2">300%</div>
