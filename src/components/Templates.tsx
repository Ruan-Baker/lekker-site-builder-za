  ...
  const industryTemplates = [
    {
      ...
      description: "Perfect for restaurants, cafes, and food service businesses looking to take online orders and showcase their menu."
    },
    {
      ...
      description: "Ideal for consultants, lawyers, accountants, and other professionals who need to showcase their expertise and book appointments."
    },
    {
      ...
      description: "Build a beautiful online store with product listings, secure checkout, and inventory management for your retail business."
    },
    {
      ...
      description: "Create booking systems, accommodation listings, and tour packages for travel agencies, hotels, and tourism businesses."
    },
    {
      ...
      description: "Perfect for wellness centers, gyms, yoga studios, and health practitioners to manage appointments and promote services."
    },
    {
      ...
      description: "Showcase your construction projects, services, and expertise with templates designed for builders, electricians, and tradespeople."
    }
  ];
